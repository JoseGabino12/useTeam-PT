      ...
      >
        <div className="flex flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "outline-none border-none shadow-none focus-visible:ring-0 focus-visible:outline-none focus-visible:border-none placeholder:text-muted-foreground/70 flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed",
              {
